...
import Box from "./components/2048/box";
import FailAnnounce from "./components/2048/FailAnnounce";
...
const Game = () => {
  ...
  return (
    <>
      <div
        className="flex h-screen w-full flex-wrap items-center justify-center bg-[#232B2B] bg-cover bg-no-repeat"
        tabIndex={0}
        onKeyDown={(e) => handleKeyDown(e)}
      >
        <div className="mr-5 block">
